...
@Log4j2
public class SqlBorrowRecordDao implements BorrowRecordDao {

    private final ConnectionPool connectionPool;
    private static volatile BorrowRecordDao instance;
    ...
    public static BorrowRecordDao getInstance() {
        if (instance == null) {
            synchronized (SqlBorrowRecordDao.class) {
                if (instance == null) {
                    instance = new SqlBorrowRecordDao(ConnectionPool.getInstance());
                }
            }
        }
        return instance;
